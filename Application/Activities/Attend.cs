    ...
    public class Attend
    {
        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            public async Task<Unit> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                if (activity == null)
                    throw new RestExeption(HttpStatusCode.NotFound, new { Activity = "Coud Not Found Activity" });
                ...
                if(attendance != null)
                    throw new RestExeption(HttpStatusCode.BadRequest, new { Attendance = "Already attending this activity" });
